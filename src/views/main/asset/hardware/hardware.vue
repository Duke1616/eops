  ...
  data() {
    return {
      form: {
        ...
        pod: 'nginx-54bcfc567b-h5rbh', // 默认 Pod 名称为 "nginx"
        container: 'nginx' // 默认容器名称为 "nginx"
      }
    }
  },
  methods: {
    onSubmit() {
      ...
      const ws = new WebSocket(
        'ws://127.0.0.1:8081/ekube/api/v1/terminal/namespaces/default/pods/nginx-54bcfc567b-6dr5l/exec'
      )
